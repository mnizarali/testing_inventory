...
<section class="section">
    <div class="section-body">
        ...
        <div class="d-flex justify-content-between align-items-center p-2">
            <div>
                <h4>Transaction</h4>
                <h6 class="font-weight-light">Controls / <span class="font-weight-bold" style="color:green;">Stock-In Transaction</span></h6>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form - Stock In <i class="fas fa-download ml-2"></i></h4>
                    </div>
                    <form method="POST" action="{{ route('transaction.stockin.store') }}" class="needs-validation">
                        @csrf
                        <div class="card-body">
                            <div class="row mb-0">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <select id="supplier_id" class="form-control" name="supplier_id" tabindex="2" required>
