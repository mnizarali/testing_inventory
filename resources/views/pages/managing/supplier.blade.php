...
<div class="d-flex justify-content-between align-items-center p-2">
    <div>
        <h4>Managing</h4>
        <h6 class="font-weight-light">Data & Account / <span class="font-weight-bold">Suppliers</span></h6>
    </div>
    <form action="{{ route('managing.supplier.category') }}" method="GET">
                ...
                <div class="card-header-form">
                    <div class="input-group">
                        <div class="input-group-btn">
                            ...
                            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#addSupplierModal"><i class="fas fa-plus"></i> Tambah Supplier Baru</button>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td style="display:flex; align-items:center; justify-content:center;">
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('managing.supplier.delete', $supplier    ->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('POST')
                        ...
                        <div class="modal fade" tabindex="-1" role="dialog" id="editSupplierModal{{$supplier->id}}">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('managing.supplier.edit', $supplier->id) }}" class="needs-validation" enctype="multipart/form-data">
                                        @csrf
...
<div class="modal fade" tabindex="-1" role="dialog" id="addSupplierModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('managing.supplier.store') }}" class="needs-validation" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <!-- Kolom Kiri -->
